...
public class UpdateWishlistInteractor implements UpdateWishlistInputBoundary {
    ...
    public UpdateWishlistInteractor(UpdateWishlistDataAccessInterface userDataAccessObject, UpdateWishlistOutputBoundary updateCartPresenter) {
    ...
    public void execute(UpdateWishlistInputData updateWishlistInputData) {
        ...
        if (!userDataAccessObject.isAuthenticated(username, password)) {
            ...
            UpdateWishlistOutputData outputData = new UpdateWishlistOutputData(wishlist);
